...
saving_image_number=1 ############### CHANGE THIS NUMBER ACCORDINGLY EVERY TIME YOU RERUN THE CODE
...
def update_check_set():
    ...
    check_8=Checkbutton(root,text='',variable=var_8,state=State[ind_mat[6]],command=lambda: update_check_set_var_8(var_8.get()))
    ...
    LOCK_8=Checkbutton(root,text='',variable=Lvar_8,state=State[ind_mat[6]],command=lambda: L_update_check_set_var_8(Lvar_8.get()))
    ...
    check_9=Checkbutton(root,text='',variable=var_9,state=State[ind_mat[7]],command=lambda: update_check_set_var_9(var_9.get()))
    ...
    LOCK_9=Checkbutton(root,text='',variable=Lvar_9,state=State[ind_mat[7]],command=lambda: L_update_check_set_var_9(Lvar_9.get()))
    ...
    check_10=Checkbutton(root,text='',variable=var_10,state=State[ind_mat[8]],command=lambda: update_check_set_var_10(var_10.get()))
    ...
    LOCK_10=Checkbutton(root,text='',variable=Lvar_10,state=State[ind_mat[8]],command=lambda: L_update_check_set_var_10(Lvar_10.get()))
    ...
    check_11=Checkbutton(root,text='',variable=var_11,state=State[ind_mat[9]],command=lambda: update_check_set_var_11(var_11.get()))
    ...
    LOCK_11=Checkbutton(root,text='',variable=Lvar_11,state=State[ind_mat[9]],command=lambda: L_update_check_set_var_11(Lvar_11.get()))
    ...
    check_12=Checkbutton(root,text='',variable=var_12,state=State[ind_mat[10]],command=lambda: update_check_set_var_12(var_12.get()))
    ...
    LOCK_12=Checkbutton(root,text='',variable=Lvar_12,state=State[ind_mat[10]],command=lambda: L_update_check_set_var_12(Lvar_12.get()))
    ...
    check_13=Checkbutton(root,text='',variable=var_13,state=State[ind_mat[11]],command=lambda: update_check_set_var_13(var_13.get()))
    ...
    LOCK_13=Checkbutton(root,text='',variable=Lvar_13,state=State[ind_mat[11]],command=lambda: L_update_check_set_var_13(Lvar_13.get()))
    ...
    check_14=Checkbutton(root,text='',variable=var_14,state=State[ind_mat[12]],command=lambda: update_check_set_var_14(var_14.get()))
    ...
    LOCK_14=Checkbutton(root,text='',variable=Lvar_14,state=State[ind_mat[12]],command=lambda: L_update_check_set_var_14(Lvar_14.get()))
    ...
    check_15=Checkbutton(root,text='',variable=var_15,state=State[ind_mat[13]],command=lambda: update_check_set_var_15(var_15.get()))
    ...
    LOCK_15=Checkbutton(root,text='',variable=Lvar_15,state=State[ind_mat[13]],command=lambda: L_update_check_set_var_15(Lvar_15.get()))
...
def add_seg():
    ...
    save_seg=Button(root,text="Save Segmentation",command=save_mask)
...
def draw():
    ...
    #SIZE(SLIDER)
    size=Scale(root,from_=1, to=50, variable = var,sliderlength=40,length=600, orient=HORIZONTAL)
    size.grid(row=16,column=6,rowspan=2,columnspan=5)
...
#CHECKPOINT
def save_mask():
    global saving_image_number
    folder_selected = filedialog.askdirectory()
    path=folder_selected+"/"+str(saving_image_number)+".png"
    enh_encoded_mask=encoded_mask*18#(255/14=18.214)
    cv2.imwrite(path,enh_encoded_mask)
    saving_image_number+=1
